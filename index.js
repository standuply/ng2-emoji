define("ng2-emoji.service", ["require", "exports", "tslib", "@angular/core"], function (require, exports, tslib_1, core_1) {
    "use strict";
    var Ng2EmojiService_1;
    Object.defineProperty(exports, "__esModule", { value: true });
    let Ng2EmojiService = Ng2EmojiService_1 = class Ng2EmojiService {
        constructor() {
        }
    };
    ...
    Ng2EmojiService.emojisRegex = new RegExp(':(' + Ng2EmojiService_1.emojis.join('|') + '):', 'g');
    Ng2EmojiService = Ng2EmojiService_1 = tslib_1.__decorate([
        core_1.Injectable(),
        tslib_1.__metadata("design:paramtypes", [])
    ], Ng2EmojiService);
    exports.Ng2EmojiService = Ng2EmojiService;
});
define("ng2-emoji.pipe", ["require", "exports", "tslib", "@angular/core", "ng2-emoji.service", "@angular/platform-browser"], function (require, exports, tslib_2, core_2, ng2_emoji_service_1, platform_browser_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let Ng2EmojiPipe = class Ng2EmojiPipe {
        ...
        transform(value, args) {
            ...
            return this._sanitizer.bypassSecurityTrustHtml(value.replace(ng2_emoji_service_1.Ng2EmojiService.emojisRegex, function (match, text) {
                return `<i class="emoji icon-ng2_em_${text}" title=":${text}:" style="display:inline-block;"></i>`;
            }));
        }
    };
    Ng2EmojiPipe = tslib_2.__decorate([
        core_2.Pipe({
            name: 'emojis'
        }),
        tslib_2.__metadata("design:paramtypes", [platform_browser_1.DomSanitizer])
    ], Ng2EmojiPipe);
    exports.Ng2EmojiPipe = Ng2EmojiPipe;
});
define("ng2-emoji.module", ["require", "exports", "tslib", "@angular/core", "@angular/common", "ng2-emoji.pipe", "ng2-emoji.service", "ng2-emoji.pipe", "ng2-emoji.service"], function (require, exports, tslib_3, core_3, common_1, ng2_emoji_pipe_1, ng2_emoji_service_2, ng2_emoji_pipe_2, ng2_emoji_service_3) {
    "use strict";
    var Ng2EmojiModule_1;
    Object.defineProperty(exports, "__esModule", { value: true });
    tslib_3.__exportStar(ng2_emoji_pipe_2, exports);
    tslib_3.__exportStar(ng2_emoji_service_3, exports);
    let Ng2EmojiModule = Ng2EmojiModule_1 = class Ng2EmojiModule {
        static forRoot() {
            return {
                ngModule: Ng2EmojiModule_1,
                providers: [ng2_emoji_service_2.Ng2EmojiService]
            };
        }
    };
    Ng2EmojiModule = Ng2EmojiModule_1 = tslib_3.__decorate([
        core_3.NgModule({
            imports: [
                common_1.CommonModule
            ],
            declarations: [
                ng2_emoji_pipe_1.Ng2EmojiPipe
            ],
            exports: [
                ng2_emoji_pipe_1.Ng2EmojiPipe
            ]
